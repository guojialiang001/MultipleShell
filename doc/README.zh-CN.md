...
- AI 编排智能体（多 TAB）：
  - [PRD_MULTI_TAB_AI_AGENT_ZH.md](PRD_MULTI_TAB_AI_AGENT_ZH.md)
  - [PRD_MULTI_TAB_AI_AGENT_TODO_ZH.md](PRD_MULTI_TAB_AI_AGENT_TODO_ZH.md)
  - [PRD_MULTI_TAB_AI_AGENT_PROMPTS_ZH.md](PRD_MULTI_TAB_AI_AGENT_PROMPTS_ZH.md)
- 终端视图设计与取舍：
