    ...
    <section className="space-y-4">
      ...
      <ConfirmDialog
        ...
        title={t("settings.importConfirmTitle", {
          defaultValue: "Confirm Import Backup",
        })}
        message={t("settings.importConfirmMessage", {
          defaultValue:
            "Importing this SQL backup will overwrite your current database configuration.\\nA backup will be created automatically before import for recovery.\\n\\nFile: {{file}}",
          file: selectedFileName || selectedFile,
        })}
        confirmText={t("settings.importConfirm", { defaultValue: "Import" })}
        onConfirm={() => {
