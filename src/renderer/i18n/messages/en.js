export default {
  ...
  configSelector: {
    ...
    claudeJsonLink: 'Link .claude.json (Claude Code)',
    claudeJsonLinkSupported: 'Link supported ({method})',
    claudeJsonLinkUnsupported: 'Link unsupported; will fall back to copy. {error}',
    close: 'Close',
