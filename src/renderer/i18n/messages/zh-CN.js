export default {
  ...
  configEditor: {
    ...
    proxyEnabled: '启用代理',
    proxyImplementation: '代理实现',
    proxyImplementationApp: '应用内置 Proxy',
    proxyImplementationCCSwitch: 'CC Switch Proxy',
    proxyImplementationOff: '关闭',
    proxyQueueMode: '队列模式',
    proxyQueueModeFailoverQueue: '故障转移队列',
    proxyQueueModeAllProviders: '全部 Provider',
    proxyQueueModeCustom: '自定义（白/黑名单）',
    respectCCSwitchProxyConfig: '融合 CC Switch proxy_config（作为运营开关）',
    proxyAllowProviderIds: '白名单 Provider IDs',
    proxyDenyProviderIds: '黑名单 Provider IDs',
    providerIdListPlaceholder: '用逗号/分号/换行分隔，例如：p1, p2',
    appFailoverEnabled: '启用 Failover',
    appBreakerEnabled: '启用熔断',
